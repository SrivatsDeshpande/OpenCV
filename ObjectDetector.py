...
classNames= []
classFile = '/home/pi/Desktop/opencvstuff/coco.names'

with open(classFile,'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')

configPath = '/home/pi/Desktop/opencvstuff/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'
weightsPath = '/home/pi/Desktop/opencvstuff/frozen_inference_graph.pb'
...
def capture():
    ...
    objectInfo = getObjects(img, objects = ['person','bottle','dog','door','mirror','backpack','eye glasses','traffic light','mouse','cell phone','potted plant'])
...
def detect_object():
    ...
    tts(names) #Please comment this while running test cases (test.py)
